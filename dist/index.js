...
var resultUl = exports.resultUl = {
  marginTop: '0',
  borderTop: 'none',
  boxShadow: ' -1px 3px 19px 1px rgba(0,100,0,0.25)',
  listStyle: 'none'
};

var appWrap = exports.appWrap = {
  display: 'flex',
...
var _Results = __webpack_require__(57);
...
var _websocket = __webpack_require__(59);
...
var wrapper = styles.wrapper,
    appWrap = styles.appWrap;

var FCCSearchBar = function (_React$PureComponent) {
  _inherits(FCCSearchBar, _React$PureComponent);

  function FCCSearchBar() {
    _classCallCheck(this, FCCSearchBar);

    var _this = _possibleConstructorReturn(this, (FCCSearchBar.__proto__ || Object.getPrototypeOf(FCCSearchBar)).call(this));
  ...
  _createClass(FCCSearchBar, [{
    key: 'updateResults',
    value: function updateResults(newResults) {
    ...
    value: function handleSubmit(e) {
      ...
      if (_websocket2.default) {
        _websocket2.default.emit('search-for-this', JSON.stringify({ text: searchTerm }), function (response) {
          _this2.updateResults(response);
        });
      } else {
        _axios2.default.get('http://freecodecamp.duckdns.org/search?q=' + searchTerm).then(function (response) {
          _this2.updateResults(response.data);
        }).catch(function (err) {
          console.error(err);
        });
      }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        _extends({ style: appWrap }, this.props),
        ...
        _react2.default.createElement(_Results2.default, { results: results })
      );
    }
  }]);
...
var propTypes = {
  ...
  updateSearchTerm: _propTypes2.default.func.isRequired
};
...
var _striptags = __webpack_require__(84);
...
var resultUl = styles.resultUl;


function renderListItems(results) {
  return results.map(function (result, i) {
    var _result$_source = result._source,
        title = _result$_source.title,
        _result$_source$body = _result$_source.body,
        body = _result$_source$body === undefined ? '' : _result$_source$body,
        _result$_source$descr = _result$_source.description,
        description = _result$_source$descr === undefined ? '' : _result$_source$descr;

    var extract = body ? body.slice(0, 140) : description.slice(0, 140);
    return _react2.default.createElement(
      'li',
      { key: i },
      _react2.default.createElement(
...
var _FCCSearchBar = __webpack_require__(35);

var _FCCSearchBar2 = _interopRequireDefault(_FCCSearchBar);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _FCCSearchBar2.default;
module.exports = exports['default'];
...
if ('WebSocket' in window || 'MozWebSocket' in window) {
  socket = _socket2.default.connect('http://freecodecamp.duckdns.org');
} else {
  socket = false;
}
